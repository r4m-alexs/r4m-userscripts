// ==UserScript==
// @name        R4M getInfo + listing helpers
// @namespace   Violentmonkey Scripts
// @description Standalone browser build of the Route4Me Postman helpers: getInfo() + all listing helpers on window/r4m.*
// @include     /^https?\:\/\/go.route4me\.com(:\d+)?\/.*$/
// @include     /^https?\:\/\/go.routeml\.com(:\d+)?\/.*$/
// @include     /^https?\:\/\/(.+\.)?routeml\.com(:\d+)?\/.*$/
// @include     /^https?\:\/\/(.+\.)?route4me\.com(:\d+)?\/.*$/
// @match       https://*.routesinc.com/*
// @match       https://*.broonosupport.com/*
// @match       https://*.routesupport.com/*
// @match       https://routes.azuga.com/*
// @exclude     https://route4me.atlassian.com/*
// @exclude     https://storefront.route4me.com/*
// @exclude     https://shopify-curbside.routeml.com/*
// @exclude     https://shopify-curbside.route4me.com/*
// @exclude     https://shopify.routeml.com/*
// @exclude     https://shopify.route4me.com/*
// @exclude     https://t.route4me.com/*
// @exclude     https://t.routeml.com/*
// @exclude     https://root.routesinc.com/*
...
// GENERATED by build-userscript-r4m.js from postman.package.js — do not edit; edit the source
// or userscript-r4m/browser-bindings.js / page-attach.js and rebuild (npm run build:userscript).

(function () {
'use strict';
function __r4m_main() {
'use strict';
if (window.r4m && window.r4m.__userscript) return;   // already installed on this page
